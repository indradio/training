  <div class="wrapper">
    <div class="page-header clear-filter" filter-color="orange">
      <div class="rellax-header rellax-header-sky" data-rellax-speed="-4">
        <div class="page-header-image" style="background-image: url('<?= base_url(); ?>assets/img/presentation-page/nuk-pro-back-sky.jpg')">
        </div>
      </div>
      <div class="rellax-header rellax-header-buildings" data-rellax-speed="0">
        <div class="page-header-image page-header-city" style="background-image: url('<?= base_url(); ?>assets/img/presentation-page/nuk-pro-buildings.png')">
        </div>
      </div>
      <div class="rellax-text-container">
        <h1 class="h1-seo rellax-text" data-rellax-speed="-1">Components</h1>
      </div>
      <h3 class="h3-description rellax-text" data-rellax-speed="-1">A beautiful premium Bootstrap 4 UI Kit.</h3>
      <h6 class="category category-absolute rellax-text" data-rellax-speed="-1">Designed by
        <a href="http://invisionapp.com/" target="_blank">
          <img src="<?= base_url(); ?>assets/img/invision-white-slim.png" class="invision-logo" />
        </a>. Coded by
        <a href="https://www.creative-tim.com" target="_blank">
          <img src="<?= base_url(); ?>assets/img/creative-tim-white-slim2.png" class="creative-tim-logo" />
        </a>.</h6>
    </div>
    <div class="main">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-8 col-sm-5">
                    <select class="selectpicker" data-style="btn btn-info btn-round btn-block" multiple title="Choose City" data-size="7">
              ...
              <div class="col-md-4">
                ...
                <div class="row">
                  <div class="col-lg-5 col-md-8">
                    <div class="dropdown">
                      <button class="btn btn-primary btn-round dropdown-toggle btn-block" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Dropdown
                      </button>
                ...
                <div class="row">
                  <div class="col-md-3">
                    <!--
										color-classes: "nav-pills-primary", "nav-pills-info", "nav-pills-success", "nav-pills-warning","nav-pills-danger"
									-->
                    <ul class="nav nav-pills nav-pills-info nav-pills-just-icons flex-column" role="tablist">
                      <li class="nav-item">
        ...
        <div id="pre-footer-areas">
          ...
          <div class="social-line social-line-big-icons social-line-black">
            <div class="container">
              <div class="row">
                <div class="col-md-2">
                  <a href="#pablo" class="btn btn-outline-default btn-icon btn-footer">
                    <i class="fab fa-twitter"></i>
                  </a>
                </div>
                <div class="col-md-2">
          ...
          <div id="images">
            ...
            <div class="row">
              <div class="col-sm-2">
                ...
                <img src="<?= base_url(); ?>assets/img/julie.jpg" alt="Rounded Image" class="rounded">
              </div>
              <div class="col-sm-2">
                <p class="category">Circle Image</p>
                <img src="<?= base_url(); ?>assets/img/julie.jpg" alt="Circle Image" class="rounded-circle">
              </div>
              <div class="col-sm-2">
                <p class="category">Raised</p>
                <img src="<?= base_url(); ?>assets/img/julie.jpg" alt="Raised Image" class="rounded img-raised">
              </div>
              <div class="col-sm-2">
                <p class="category">Circle Raised</p>
                <img src="<?= base_url(); ?>assets/img/julie.jpg" alt="Thumbnail Image" class="rounded-circle img-raised">
              </div>
            </div>
          </div>
        </div>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="text-right">
                                <button type="button" rel="tooltip" class="btn btn-info btn-icon btn-round btn-sm ">
                                  <i class="now-ui-icons users_single-02"></i>
                                </button>
                                <button type="button" rel="tooltip" class="btn btn-success btn-icon btn-round btn-sm ">
                                  <i class="now-ui-icons ui-2_settings-90"></i>
                                </button>
                                <button type="button" rel="tooltip" class="btn btn-danger btn-icon btn-round btn-sm ">
                                  <i class="now-ui-icons ui-1_simple-remove"></i>
                                </button>
                              </td>
                            </tr>
                        ...
                        <table class="table table-shopping">
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div class="img-container">
                                  <img src="<?= base_url(); ?>assets/img//saint-laurent.jpg" alt="...">
                                </div>
                              </td>
                              <td class="td-name">
                            ...
                            <tr>
                              <td>
                                <div class="img-container">
                                  <img src="<?= base_url(); ?>assets/img//balmain.jpg" alt="...">
                                </div>
                              </td>
                              <td class="td-name">
                            ...
                            <tr>
                              <td>
                                <div class="img-container">
                                  <img src="<?= base_url(); ?>assets/img//prada.jpg" alt="...">
                                </div>
                              </td>
                              <td class="td-name">
              ...
              <div class="col-md-6 col-lg-3">
                <div class="card card-profile">
                  ...
                  <div class="card-body">
                    ...
                    <div class="card-footer">
                      <a href="#pablo" class="btn btn-icon btn-neutral btn-lg btn-twitter"><i class="fab fa-twitter"></i></a>
                      <a href="#pablo" class="btn btn-icon btn-neutral btn-lg btn-dribbble"><i class="fab fa-dribbble"></i></a>
                      <a href="#pablo" class="btn btn-icon btn-neutral btn-lg btn-instagram"><i class="fab fa-instagram"></i></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-3">
                <div class="card card-profile">
                  <div class="card-body">
                    ...
                    <div class="card-footer">
                      <a href="#pablo" class="btn btn-icon btn-outline-primary btn-round"><i class="fab fa-twitter"></i></a>
                      <a href="#pablo" class="btn btn-icon btn-outline-primary btn-round"><i class="fab fa-facebook-square"></i></a>
                      <a href="#pablo" class="btn btn-icon btn-outline-primary btn-round"><i class="fab fa-google"></i></a>
                    </div>
                  </div>
                </div>
              </div>
