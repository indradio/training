	                                    ...
	                                    <div class="form-group">
                                            ...
                                            <div class=" btn-group-toggle" data-toggle="buttons">
                                                ...
                                                <label class="btn btn-info">
                                                    <input type="radio" name="options" id="option1" autocomplete="off" value="A"> <?= $soal['pilihan_a']; ?>
                                                </label>
                                                </br>
                                                ...
                                                <label class="btn btn-info">
                                                    <input type="radio" name="options" id="option2" autocomplete="off" value="B"> <?= $soal['pilihan_b']; ?>
                                                </label>
                                                </br>
                                                ...
                                                <label class="btn btn-info">
                                                    <input type="radio" name="options" id="option3" autocomplete="off" value="C"> <?= $soal['pilihan_c']; ?>
                                                </label>
                                                </br>
                                                <?php if ($soal['gambar_c']){ ?>
                                                <p>
                                                ...
                                                <label class="btn btn-info">
                                                    <input type="radio" name="options" id="option4" autocomplete="off" value="D"> <?= $soal['pilihan_d']; ?>
                                                </label>
                                            </div>
                                        </div>
                                        </br>
